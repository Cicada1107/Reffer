...
export default function userSentRequests() {
  ...
  if (error) {
    return (
      <div className="w-full min-h-screen pt-20 pb-8 flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black relative before:absolute before:inset-0 before:bg-gradient-to-t before:from-purple-900/20 before:via-transparent before:to-purple-800/10 before:pointer-events-none">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                  ...
                  <div className="flex gap-4 items-start flex-1">
                    ...
                    <div className="flex flex-col text-white space-y-0.5">
                      <div className="text-base font-semibold">{request.employee.name}</div>
                      <div className="text-sm text-white/70">{request.employee.email}</div>
                      ...
                      {request.employee.college && (
                        <div className="text-xs text-white/60">{request.employee.college}</div>
                      )}
