//use the /api/user/requests/received endpoint
'use client'
            ...
            <div className="space-y-4">
                ...
                <div key={request.id} className="bg-white/5 backdrop-blur-md border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-colors">
                    ...
                    <div className="flex items-center space-x-4 flex-1">
                        ...
                        <h3 className="text-white font-semibold text-lg">{request.requester.name}</h3>
                        <p className="text-white/60 text-sm">{request.requester.email}</p>
                        ...
                        {request.requester.college && (
                            <p className="text-white/60 text-xs">{request.requester.college}</p>
                        )}
